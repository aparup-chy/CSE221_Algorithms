...
# It iterates through the list, calculating the sum of each pair of elements. If a pair with the target sum S is found,
# it writes the indices of the pair to an output file. If no such pair is found, it writes "IMPOSSIBLE" to the file.